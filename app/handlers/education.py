...
def handle_education(user_input: str, current_list: List[Dict], language: str) -> Dict[str, Any]:
    return handle_list_section(user_input, current_list, "education", "skills", language)
