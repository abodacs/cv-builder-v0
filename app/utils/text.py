...
def format_cv_text(state: CVState) -> str:
    ...
    sections = {
        ...
        "education": _format_section(state.education, "التعليم" if lang == "ar" else "Education"),
        "experience": _format_section(state.work_experience, "الخبرة المهنية" if lang == "ar" else "Work Experience"),
        "skills": _format_skills(state.skills, "المهارات" if lang == "ar" else "Skills")
    }
